	...
	*/
	...
	function jSignatureClass(parent, options, instanceExtensions) {
		...
		var $parent = this.$parent = $(parent)
			...
			, settings = {
				'controllBarTopClass': 'sign__controlbar_top'
				, 'controllBarBottomClass': 'sign__controlbar_bottom'
				, 'width': 'ratio'
				, 'height': 'ratio'
		...
		this.$controlbarUpper = $('<div class="sign__controlbar ' + this.settings.controllBarTopClass + '"></div>').appendTo($parent);
